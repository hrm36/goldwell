		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				@if(count($errors) > 0)
                        ...
                        @endif
				<form id="form" class="form-horizontal" role="form" action="{{route('edit-brand',['id'=>$brand->id])}}" 
								...
								<div class="form-group {{ $errors->has('banner') ? 'has-error' : '' }}">
									...
									<div class="col-sm-10">
										...
										<div id="preview" style="display: block;margin-bottom: 20px">
											<div class="img_preview"><img src="{{$brand->image}}"/>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<select class="form-control m-b" name="status">
											<option {{$brand->status == 1 ? "selected" : ""}} value="1">Công khai</option>
											<option {{$brand->status == 0 ? "selected" : ""}} value="0">Không công khai</option>
										</select>                                       
									</div>
								</div>	 	                            	
							</div>
