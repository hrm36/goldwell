...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-4">
		...
		<ol class="breadcrumb">
			...
			<li class="active">
				<strong>Thay đổi thông tin trang danh mục sản phẩm</strong>
			</li>
		</ol>
	</div>
</div>
	...
	<div class="row animated fadeInRight">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				...
				@endif
				<form class="form-horizontal" role="form" action="{{route('thong-tin-trang-td')}}" 
					...
					<div class="col-sm-10">
						<div class="input-group">
							<span class="input-group-btn">
								...
								class="btn btn-primary red iframe-btn" id="iframe-update-info-page"><i
...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		settingIframe("#iframe-update-info-page");
	});
</script>
@stop