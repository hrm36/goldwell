	...
	<div class="row animated fadeInRight">		
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				...
				@endif
				<form id="form" class="form-horizontal" role="form" action="{{route('create-color')}}" 
								...
								<div class="col-sm-10">
									<div class="input-group">
										<span class="input-group-btn">
											...
											class="btn btn-primary red iframe-btn" id="iframe-create-color"><i
...
$(document).ready(function()
{
	...
	settingIframe("#iframe-create-color");
});
</script>
@stop